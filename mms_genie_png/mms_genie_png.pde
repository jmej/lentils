...
String[] imageNames = {"yellow_200.png", "blue_200.png", "red_200.png", "green_200.png", "brown_200.png", "orange_200.png"};
...
class Lentil {
  ...
  void display(){
    float displaySize = lentilSize*0.25;
    //displaySize = map(age, 0, 30, lentilSize*2, lentilSize);
    if (age <= 4){
      displaySize = map(age, 0, 4, lentilSize*0.25, lentilSize);
    }else{
      int ageLimited = constrain(age, 5, 8);
      displaySize = map(ageLimited, 5, 8, lentilSize, lentilSize*0.25);
    }
